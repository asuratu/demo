...
namespace App\Handler\Admin\Structure\News;
...
class Read extends AbstractCommon {
    ...
    public function processRequest(Array & $context) {
        ...
        $_where .= ' AND a.`category_id` = c.`category_id` AND c.`root_id` = c2.`category_id` AND  (c.`root_id` = 23 OR c.`root_id` = 95)';
            ...
            foreach ($_rs as $m) {
                ...
                array_push($_rsp['rows'], array(
                    ...
                    'cell' => array(
                        ...
                        $m->category_name,
                        $m->title,
                        Helper::createSmallImg($context['__CDN__'], $context['__ASSETS__'], $m->cover, $m->title),
