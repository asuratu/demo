...
?>
    <div class="container">
        ...
        <div class="down_cont">
            <div class="all">
                <h3>Download Center<span>Please select the encode type you need to download</span></h3>
                <div class="menu_cont">
                    <div class="item_menu">
                        <?php
                ...
                <div class="list">
                    <ul class="clearboth">
                        ...
                        foreach ($this->currentListRs as $val):
                            ?>
                            <li><span><?= $i+($this->currentPage - 1)*$this->currentPageSize?></span><em><?= $val->file_name?></em><a href="/uploads/files/<?= $val->file_url?>" target="_blank">Download</a></li>
                            <?php
                            $i++;
                        endforeach;
                        ?>
