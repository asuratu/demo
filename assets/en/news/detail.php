...
?>
    <div class="container">
        <div class="sub_banner">
            ...
            ?>
            <div class="fix">
                <i><?= $this->rootName ?></i><?= $this->rootEnglishName ?> <p>Postion：<?= $this->getNoaBreadcrumb ?></p>
            </div>
        </div>
        ...
        <div class="news_det">
            <div class="all clearboth">
                <div class="title">
                    <h3><?= $this->title ?></h3>
                    <span></span>
                    <p><?= $this->releaseDate ?> <i>share：</i></p>
                    <?= $this->getEnPrevNext ?>
                </div>
                <div class="right">
                    <div class="html">
                    ...
                    <a href="javascript:history.back(-1);" class="back">Return list ></a>
                </div>
            </div>
        </div>
    </div>
