			...
			return {
				...
				read : function() {
					$(this.grid).dataGrid({
						...
						colModel : [
							{display:'ID', name:'r.recruit_id', width:30, align:'center', css:'num'},
							{display:'招聘岗位', width:150, align:'center'},
							{display:'是否上架', width:60, name:'r.is_display', align:'center'},
							{display:'排序', width:40, name:'r.sort', align:'center'},
							{display:'修改日期', width:150, name:'r.release_date', align:'center'},
						],
						useSelect : true
