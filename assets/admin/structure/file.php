			...
			return {
				...
				read : function() {
					$(this.grid).dataGrid({
						...
						colModel : [
							{display:'ID', name:'f.file_id', width:30, align:'center', css:'num'},
							{display:'id_tree', width:150, align:'center'},
							{display:'所属栏目', width:200, name:'s.name', align:'center'},
							{display:'文件名', width:200, align:'center'},
							{display:'是否上架', width:60, name:'f.is_display', align:'center'},
							{display:'排序', width:40, name:'f.sort', align:'center'},
							{display:'修改时间', width:150, name:'f.release_date', align:'center'},
						],
						useSelect : true
